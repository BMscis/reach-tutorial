...
import { balance } from "../../Stores/Wallet/WalletStore";
...
afterUpdate(() => {
    ...
    clicked ? nftAssetOwnerColor = "#75f20080" : nftAssetOwnerColor = "#00000099";
...
{#if clicked}
    ...
    {/await}
{/if}
<button id="nftAssetOwner-button" class="tr" style="width:24px;height:24px;" on:click={(() => {clicked = !clicked})}>
