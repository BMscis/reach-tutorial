In this tutorial, we will be creating a simple smart contract that will allow us to mint a new NFT. We will be using the reach programming language to write our smart contract.
